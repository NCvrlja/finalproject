 ...
 */
class getPlannerRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PlannerRepository' shared autowired service.
     *
     * @return \App\Repository\PlannerRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PlannerRepository.php';

        return $container->privates['App\\Repository\\PlannerRepository'] = new \App\Repository\PlannerRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
