 ...
 */
class getMealsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\MealsRepository' shared autowired service.
     *
     * @return \App\Repository\MealsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'MealsRepository.php';

        return $container->privates['App\\Repository\\MealsRepository'] = new \App\Repository\MealsRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
